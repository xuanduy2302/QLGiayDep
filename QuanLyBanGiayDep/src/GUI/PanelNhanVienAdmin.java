...
public class PanelNhanVienAdmin extends javax.swing.JPanel {
    ...
    private void load(){
       ...
       Vector header = new Vector();
        header.add("Mã người dùng");
        header.add("Họ người dùng");
        header.add("Tên người dùng");
        header.add("Địa chỉ");
        header.add("Chức vụ");
   ...
   public void reset(){
    ...
    private void initComponents() {
        ...
        cb_cv.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Quản lý", "Nhân viên bán hàng", "Nhân viên kho" }));
        ...
        pn_donvLayout.setVerticalGroup(
            ...
            .addGroup(pn_donvLayout.createSequentialGroup()
                ...
                .addGroup(pn_donvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bt_resetnv, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(pn_findnv, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        pn_ttnv.getAccessibleContext().setAccessibleName("Thông tin người dùng");
           ...
           if (bt_change1.getText().equals("Kích hoạt/Vô hiệu hóa")) {
            ...
            if(i>=0){
                try {
                    ...
                    Logger.getLogger(PanelNhanVienAdmin.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            else{
